...
export default function ServicePage({ 
  ...
  const serviceUrl = slug ? `${baseUrl}/leistungen/${slug}` : baseUrl;
  ...
  const serviceSchema = {
    ...
    "provider": {
      ...
      "image": `${baseUrl}/assets/logo-corion.jpg`,
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title={`${title} | Corion Lackdoktor Hofheim & Wiesbaden`}
        description={description}
        keywords={keywords || `${title.toLowerCase()}, lackdoktor, hofheim, wiesbaden, mainz, auto reparatur, corion`}
      ...
      <div className="relative h-[400px] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold service-title-white mb-4">
            {title}
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            {/* CTA Card - Show How It Works if pricing contains "individuell" or "foto" */}
            {pricing && (pricing.toLowerCase().includes('individuell') || pricing.toLowerCase().includes('foto')) ? (
