...
export default function Plastikreparatur() {
  ...
  return (
    <ServicePage
      ...
      description="Professionelle Reparatur von Kunststoff-Stoßfängern und Verkleidungen. Kostengünstige und umweltfreundliche Alternative zum Austausch."
      image={paintImage}
      benefits={benefits}
      process={process}
      pricing="Preis individuell – senden Sie uns ein Foto für ein kostenloses Angebot."
      slug="plastikreparatur"
      keywords="plastikreparatur hofheim, stoßfänger reparieren wiesbaden, kunststoff schweißen mainz, bumper reparatur, verkleidung reparieren, corion lackdoktor"
      priceRange="€-€€"
    />
  );
}
