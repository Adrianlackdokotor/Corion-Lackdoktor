...
export default function Autoaufbereitung() {
  ...
  return (
    <ServicePage
      ...
      description="Professionelle Fahrzeugaufbereitung innen und außen für ein perfektes Erscheinungsbild. Lackpflege, Versiegelung und Werterhalt."
      image={detailImage}
      benefits={benefits}
      process={process}
      pricing="Preis individuell – senden Sie uns ein Foto für ein kostenloses Angebot."
      slug="autoaufbereitung"
      keywords="autoaufbereitung hofheim, auto reinigung wiesbaden, fahrzeug polieren mainz, keramikversiegelung, lackversiegelung, innenraum reinigung, corion lackdoktor"
      priceRange="€-€€"
    />
  );
}
