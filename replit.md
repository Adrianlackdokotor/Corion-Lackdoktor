...
- **Academy Page**: New educational page showcasing professional training courses for KFZ professionals, including Smart Repair basics, advanced painting techniques, and certified appraiser training. Features integrated PaintMaster GPT section at top with clickable AI assistant banner, interactive prompt input, quick question buttons, and Framer Motion animations. Links to https://chat.openai.com/g/g-OyZuqL3BE-paintmaster for AI-powered learning assistance.
